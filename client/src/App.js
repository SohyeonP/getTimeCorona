  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <div class="logo"><img src={logo} alt=""></img><span class="update-date">업데이트 날짜- 2020 .09.14</span></div>
        <div className="App-title">{message}</div>
      </header>
      <body>

        <div class="search-bar"><input placeholder="코로나 내용을 검색해 주세요" /><img src={img1} alt="" /></div>
        <h3>오늘의 확진자</h3>
